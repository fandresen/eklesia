...
import logoSDA from './assets/logoSDA.png';

export default function LandingPage() { 
  const navigate = useNavigate();
  return (
    <div
      className="relative flex h-screen w-full flex-col bg-background-light group/design-root font-display"
      style={{
    ...
    >
      <div className="flex flex-col grow justify-between p-6">
        <div className="flex flex-col items-center justify-center text-center pt-16">
          <div className="relative flex w-full max-w-[280px] grow bg-background-light/0 @container aspect-square mb-6">
            <div className="w-full gap-1 overflow-hidden bg-background-light/0 @[480px]:gap-2 aspect-square flex">
              <div
                ...
                style={{
                  backgroundImage: `url(${logoSDA})`,
                  mixBlendMode: 'multiply',
                }}
              ></div>
            </div>
          </div>
          <h1 className="text-primary tracking-tight text-[32px] font-bold leading-tight px-4 text-center pb-3 pt-6">
            SDA Ambolokandrina
          </h1>
          <p className="text-primary/80 text-base font-normal leading-normal pb-3 pt-1 px-4 text-center">
